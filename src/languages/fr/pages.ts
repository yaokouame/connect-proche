...
export default {
  ...
  "wellness.goals.title": "Mes Objectifs",
  "wellness.goals.goal": "Objectif",
  "wellness.goals.completed": "Objectif atteint!",
  "wellness.goals.noGoals": "Aucun objectif défini",
  "wellness.goals.types.steps": "Pas quotidiens",
  "wellness.goals.types.water": "Hydratation",
  "wellness.goals.types.sleep": "Sommeil",
  "wellness.goals.types.activity": "Activité physique",
  "wellness.goals.types.nutrition": "Nutrition",
